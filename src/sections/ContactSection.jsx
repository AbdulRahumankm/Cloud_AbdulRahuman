...
const ContactSection = () => {
  return (
    <section id="contact-new" className="py-24 bg-devops-bg relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="flex flex-col md:flex-row items-baseline gap-4 mb-16">
          <h2 className="text-3xl md:text-4xl font-extrabold text-devops-text tracking-tight">
            <span className="text-devops-primary font-mono mr-2">07.</span> Establish Handshake
          </h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="bg-devops-card/40 backdrop-blur-xl border border-devops-border p-8 rounded-2xl flex flex-col items-center justify-center transition-all duration-500 hover:scale-[1.05] hover:shadow-[0_0_30px_rgba(16,185,129,0.15)] overflow-hidden group">
            <h3 className="text-devops-text font-bold text-lg mb-4">Resume</h3>
            <a
              href="/resume.pdf"
              download
              className="px-6 py-3 bg-gradient-to-r from-devops-primary to-devops-secondary text-devops-bg font-bold rounded-lg transition-all duration-300 hover:shadow-[0_0_20px_rgba(16,185,129,0.5)] active:scale-95"
            >
              Download PDF
            </a>
            <p className="text-[10px] font-mono text-devops-textMuted mt-4 uppercase tracking-widest opacity-60">Architectural Digest</p>
          </div>
        </div>
      </div>
    </section>
