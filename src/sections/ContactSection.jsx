...
const ContactSection = () => {
  return (
    <section id="contact" className="py-32 bg-devops-bg relative overflow-hidden border-t border-devops-border/20">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center md:text-left">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <ContactCard
            ...
            link="https://linkedin.com/in/abdulrahuman"
          ...
          <ContactCard
            ...
            link="mailto:abdulrahuman.cloud@gmail.com"
          ...
          <div className="bg-devops-card/40 backdrop-blur-xl border border-devops-border p-8 rounded-2xl flex flex-col items-center justify-center transition-all duration-500 hover:scale-[1.05] hover:shadow-[0_0_30px_rgba(16,185,129,0.15)] overflow-hidden group">
            ...
            <p className="text-[10px] font-mono text-devops-textMuted mt-6 uppercase tracking-widest opacity-60">System Architect Bio</p>
          </div>
        </div>
      </div>
    </section>
